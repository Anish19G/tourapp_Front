      ...
      <Container>
        <Row>
          ...
          <div className="d-flex align-items-center">
            <p className="pb-2"> DharcheTech, Kathmandu, Nepal</p>
          </div>

          <div className="d-flex align-items-top my-2">
          <i className="bi bi-geo-alt me-3"></i>
          <a target="_blank" href="mailto:anish19grg@gmail.com" className="d-block" >anish19grg@gmail.com</a>
          </div>
          <div className="d-flex align-items-top ">
          <i className="bi bi-telephone me-3"></i>
          <a target="_blank" href="tel:9779808107091" className="d-block" >+9779808107091</a>
          </div>
        ...
        <p className="text-light">   @ 2025. DharcheTech All rights reserved </p> 
        </Col>
        </Row>
